...
public class SinhvienpolyTest {
    ...
    @BeforeEach
    public void setUp(){
        sinhvienpoly.addSV(new Sinhvien("SV1", "Nguyen Van A", "SD18403", "Kiem thu", "ph12345"));
        sinhvienpoly.addSV(new Sinhvien("SV2", "Nguyen Van B", "SD18403", "Kiem thu", "PH12345"));
        sinhvienpoly.addSV(new Sinhvien("SV3", "Nguyen Van C", "SD18403", "Kiem thu", "ph12345"));
    ...
    public void addSV_valid_tenlop(){
        int exp = 6;
        Sinhvien sv1 = new Sinhvien("SV6", "Nguyen Van Sao", "SD18403", "K", "PH34455");
    ...
    public void addSV_valid_ID(){
        int exp = 6;
        Sinhvien sv2 = new Sinhvien("9", "Nguyen Van Sao", "SD18403", "Kiem thu", "PH34455");
    ...
    public void addSV_valid_hoten(){
        int exp = 6;
        Sinhvien sv2 = new Sinhvien("SV7", "S", "SD18403", "Kiem thu", "PH34455");
        int act = sinhvienpoly.addSV(sv2);
        Assertions.assertEquals(exp, act);
    }
    @Test
    public void addSV_valid_malop(){
        int exp = 6;
        Sinhvien sv2 = new Sinhvien("SV7", "Nguyen Van Sao", "S", "Kiem thu", "PH34455");
        int act = sinhvienpoly.addSV(sv2);
        Assertions.assertEquals(exp, act);
    }
    ...
    public void addSV_invalid_IDtrong(){
        Sinhvien sv3 = new Sinhvien("", "Nguyen Van Sao", "SD18403", "Kiem thu", "PH34455");
    ...
    public void addSV_invalid_maloptrong(){
        Sinhvien sv3 = new Sinhvien("SV8", "Nguyen Van Sao", "", "Kiem thu", "PH34455");
        Assertions.assertThrows(NullPointerException.class, ()->{
            sinhvienpoly.addSV(sv3);
        });
    }
    ...
    public void addSV_invalid_tenloptrong(){
        Sinhvien sv3 = new Sinhvien("SV8", "Nguyen Van Sao", "SD18403", "", "PH34455");
        Assertions.assertThrows(NullPointerException.class, ()->{
            sinhvienpoly.addSV(sv3);
        });
    }
    ...
    public void addSV_invalid_masvtrong(){
        Sinhvien sv3 = new Sinhvien("SV8", "Nguyen Van Sao", "SD18403", "Kiem thu", "");
        Assertions.assertThrows(NullPointerException.class, ()->{
            sinhvienpoly.addSV(sv3);
        });
    }
    ...
    public void addSV_invalid_tenlopchuakytudacbiet(){
        Sinhvien sv3 = new Sinhvien("SV8", "Nguyen Van Sao", "SD18403", "Kiem@thu", "PH34455");
...
//    Phân vùng tương đương
    ...
    public void searchSV_valid_kocomasv(){
        int exp = 0;
        int act = sinhvienpoly.timKiemTheoMa("ph334455");
        Assertions.assertEquals(exp, act);
    }
    @Test
    public void searchSV_invalid_masvqua20kytu(){
        Assertions.assertThrows(IllegalArgumentException.class, ()->{
            sinhvienpoly.timKiemTheoMa("PH12345123456789123456789");
        });
    }
}
